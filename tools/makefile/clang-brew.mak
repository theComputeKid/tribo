...
CCXXFLAGS_COMMON = $(WARNINGS) -MMD -fopenmp -isystem$(shell xcrun --show-sdk-path)/usr/include
...
# C++ flags.
CXXFLAGS_COMMON = -std=c++23 -isystem$(shell brew --prefix llvm)/include/c++/v1
